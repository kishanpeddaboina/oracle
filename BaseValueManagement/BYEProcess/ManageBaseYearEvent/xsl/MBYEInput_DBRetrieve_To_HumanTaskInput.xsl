...
<xsl:stylesheet version="1.0" xmlns:ns5="http://xmlns.oracle.com/bpm/bpmobject/Data/UIStateBO" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:inp2="http://assessor.lacounty.gov/amp/type/common/ResponseHeader/v1.0" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:bpmo="http://xmlns.oracle.com/bpm/bpmobject/" xmlns:inp1="http://assessor.lacounty.gov/amp/type/common/RequestHeader/v1.0" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:ns2="http://xmlns.oracle.com/bpm/bpmobject/Data/SortBYEBO" xmlns:ns3="http://xmlns.oracle.com/bpm/bpmobject/Data/AssignToUserOrGroupBO" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns1="http://assessor.lacounty.gov/amp/data/bvm/RetrieveBYE/v1.0" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:ns0="http://xmlns.oracle.com/bpm/bpmobject/Data/RetriveBYEDetails" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:inp3="http://assessor.lacounty.gov/amp/type/bvm/BaseYearEvent/v1.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:tns="http://assessor.lacounty.gov/amp/data/bvm/ManageBYE/v1.0" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl ns5 inp2 bpmo inp1 ns2 ns3 ns1 ns0 inp3 xsd tns xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas">
    ...
    <ns0:RetriveBYEDetails>
      <ns1:RetrieveBYEDetails>
        <ns1:BYEDetailsOriginal>
          ...
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsOriginal/ns1:ainType">
            <ns1:ainType>
        ...
        <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsUserModified">
          <ns1:BYEDetailsUserModified>
            ...
            <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsUserModified/ns1:ainType">
              <ns1:ainType>
      ...
      <ns0:sortBYE>
        ...
        <ns2:assignedBy>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:assignedBy/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:assignedBy/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:assignedBy"/>
        </ns2:assignedBy>
        <ns2:updatedBy>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedBy/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedBy/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedBy"/>
        </ns2:updatedBy>
        <ns2:updatedDate>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedDate/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedDate/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedDate"/>
        </ns2:updatedDate>
        <ns2:milestone>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:milestone/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:milestone/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:milestone"/>
        </ns2:milestone>
        <ns2:updatedByInfo>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedByInfo/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedByInfo/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:sortBYE/ns2:updatedByInfo"/>
        </ns2:updatedByInfo>
      </ns0:sortBYE>
      <ns0:assignTo_UserID>
      ...
      <tns:manageBYERequest>
        <tns:header>
          <xsl:if test="/tns:manageBYERequest/tns:header/inp1:applicationId">
            <inp1:applicationId>
              <xsl:value-of select="/tns:manageBYERequest/tns:header/inp1:applicationId"/>
            </inp1:applicationId>
          </xsl:if>
          <xsl:if test="/tns:manageBYERequest/tns:header/inp1:requestId">
            <inp1:requestId>
        ...
        <xsl:if test="/tns:manageBYERequest/tns:aoid">
          <tns:aoid>
            <xsl:value-of select="/tns:manageBYERequest/tns:aoid"/>
          </tns:aoid>
        </xsl:if>
        <xsl:if test="/tns:manageBYERequest/tns:userId">
          <tns:userId>
            <xsl:value-of select="/tns:manageBYERequest/tns:userId"/>
          </tns:userId>
        </xsl:if>
        <xsl:if test="/tns:manageBYERequest/tns:ownerId">
          <tns:ownerId>
            <xsl:value-of select="/tns:manageBYERequest/tns:ownerId"/>
          </tns:ownerId>
        </xsl:if>
        <tns:processType>
