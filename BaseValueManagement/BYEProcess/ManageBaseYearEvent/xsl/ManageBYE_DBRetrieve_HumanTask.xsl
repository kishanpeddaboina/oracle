    ...
    <ns0:RetriveBYEDetails>
      <ns1:RetrieveBYEDetails>
        <ns1:BYEDetailsOriginal>
          ...
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsOriginal/ns1:reviewRequired">
            <ns1:reviewRequired>
        ...
        <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsUserModified">
          <ns1:BYEDetailsUserModified>
            ...
            <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns1:RetrieveBYEDetails/ns1:BYEDetailsUserModified/ns1:reviewRequired">
              <ns1:reviewRequired>
      ...
      <ns0:assignmentBox>
        <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/@xsi:nil">
          <xsl:attribute name="xsi:nil">
            <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/@xsi:nil"/>
          </xsl:attribute>
        </xsl:if>
        <ns3:assignmentBox_UserId>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_UserId/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_UserId/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_UserId"/>
        </ns3:assignmentBox_UserId>
        <ns3:assignmentBox_GroupId>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_GroupId/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_GroupId/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:assignmentBox_GroupId"/>
        </ns3:assignmentBox_GroupId>
        <ns3:userType>
          <xsl:if test="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:userType/@xsi:nil">
            <xsl:attribute name="xsi:nil">
              <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:userType/@xsi:nil"/>
            </xsl:attribute>
          </xsl:if>
          <xsl:value-of select="$RetriveBYE_PDO/ns0:RetriveBYEDetails/ns0:assignmentBox/ns3:userType"/>
        </ns3:userType>
      </ns0:assignmentBox>
      <ns0:assignedBy>
