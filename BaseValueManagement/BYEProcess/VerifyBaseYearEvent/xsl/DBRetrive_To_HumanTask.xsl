      ...
      <ns1:RetrieveBYEDetails>
        <ns1:BYEDetailsOriginal>
          <ns1:header>
            ...
            <xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:header/inp2:requestId">
              <inp2:requestId>
          ...
          <xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:dbLockStatus">
            <ns1:dbLockStatus>
              <xsl:value-of select="/tns:retrieveBaseYearEventsResponse/tns:dbLockStatus"/>
            </ns1:dbLockStatus>
          </xsl:if>
          <xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:lockedByUserId">
            <ns1:lockedByUserId>
          ...
          <xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:region">
            <ns1:region>
          ...
          <!--xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:clusterNumber">
            <ns1:clusterNumber>
              <xsl:value-of select="/tns:retrieveBaseYearEventsResponse/tns:clusterNumber"/>
            </ns1:clusterNumber>
          </xsl:if-->
            ...
            <xsl:for-each select="/tns:retrieveBaseYearEventsResponse/tns:baseYearEventList/tns:baseYearEvent">
              <xsl:if test=".">
                <ns1:baseYearEvent>
                  ...
                  <inp3:reviewRequired>
                    <xsl:value-of select="../../tns:reviewRequired"/>
                  </inp3:reviewRequired>
                  <inp3:byeId>
                  ...
                  <!--xsl:if test="inp3:eventName">
                  <inp3:eventName>
                    <xsl:value-of select="inp3:eventName"/>
                  </inp3:eventName>
                </xsl:if-->
                  <!--xsl:if test="inp3:eventDescription">
                  <inp3:eventDescription>
                    <xsl:value-of select="inp3:eventDescription"/>
                  </inp3:eventDescription>
                </xsl:if-->
                  ...
                  <!--xsl:if test="inp3:landReasonCode">
                  <inp3:landReasonCode>
                    <xsl:value-of select="inp3:landReasonCode"/>
                  </inp3:landReasonCode>
                </xsl:if-->
                  <!--xsl:if test="inp3:improvementReasonCode">
                  <inp3:improvementReasonCode>
                    <xsl:value-of select="inp3:improvementReasonCode"/>
                  </inp3:improvementReasonCode>
                </xsl:if-->
        ...
        <ns1:BYEDetailsUserModified>
          ...
          <xsl:if test="/tns:retrieveBaseYearEventsResponse/tns:processStatus">
            <ns1:processStatus>
              <xsl:value-of select="/tns:retrieveBaseYearEventsResponse/tns:processStatus"/>
            </ns1:processStatus>
          </xsl:if>
