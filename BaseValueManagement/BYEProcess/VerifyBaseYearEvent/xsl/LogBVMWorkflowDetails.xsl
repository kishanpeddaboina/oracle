...
<xsl:stylesheet version="1.0" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ns1="http://xmlns.oracle.com/bpel/workflow/common" xmlns:inp2="http://assessor.lacounty.gov/amp/type/common/ResponseHeader/v1.0" xmlns:evidence="http://xmlns.oracle.com/bpel/workflow/TaskEvidenceService" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:bpmo="http://xmlns.oracle.com/bpm/bpmobject/" xmlns:jaxb="http://java.sun.com/xml/ns/jaxb" xmlns:ns3="http://assessor.lacounty.gov/amp/data/ao/LogWorkFlowDetails/v1.0" xmlns:inp1="http://assessor.lacounty.gov/amp/type/common/RequestHeader/v1.0" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:tns="http://assessor.lacounty.gov/amp/data/bvm/VerifyBYE/v1.0" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns2="http://xmlns.oracle.com/bpm/bpmobject/Data/ErrorBO" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:inp3="http://assessor.lacounty.gov/amp/type/bvm/BaseYearEvent/v1.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns0="http://xmlns.oracle.com/bpel/workflow/task" xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl ns1 inp2 evidence bpmo jaxb ns3 inp1 tns ns2 inp3 xsd ns0 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas">
  ...
  <xsl:template match="/">
    <ns3:logWorkFlowDetailsRequest>
      ...
      <xsl:choose>
        <xsl:when test="string-length($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:acquiredBy) > 0.0">
          <ns3:claimedBy>
      ...
      <xsl:choose>
        <xsl:when test="(contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;REJECT&quot;) or contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;ASSIGN&quot;)) or (contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:state,&quot;WITHDRAWN&quot;) or contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;CANCEL&quot;))">
          <ns3:reviewedBy>
      ...
      <xsl:choose>
        <xsl:when test="(contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;CANCEL&quot;) or contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;REJECT&quot;)) or (contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:outcome,&quot;ASSIGN&quot;) or contains($execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:state,&quot;WITHDRAWN&quot;))">
          <ns3:reviewedDate>
            <xsl:value-of select="$execDataWFLogPDO/ns0:task/ns0:systemAttributes/ns0:updatedDate"/>
          </ns3:reviewedDate>
        </xsl:when>
