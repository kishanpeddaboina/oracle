...
public class BaseYearEventRulesService_ptClient
{
  @WebServiceRef
  private static BaseYearEventRulesService_ep baseYearEventRulesService_ep;

    public static void main(String[] args) {
        try {
            baseYearEventRulesService_ep = new BaseYearEventRulesService_ep();
            BaseYearEventRulesService baseYearEventRulesService = baseYearEventRulesService_ep.getBaseYearEventRulesService_pt();

            Map<String, Object> requestContext = ((BindingProvider) baseYearEventRulesService).getRequestContext();
