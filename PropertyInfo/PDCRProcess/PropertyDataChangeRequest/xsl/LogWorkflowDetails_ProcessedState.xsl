...
<xsl:stylesheet version="1.0" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ns2="http://xmlns.oracle.com/bpel/workflow/common" xmlns:inp2="http://assessor.lacounty.gov/amp/type/common/ResponseHeader/v1.0" xmlns:evidence="http://xmlns.oracle.com/bpel/workflow/TaskEvidenceService" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:bpmo="http://xmlns.oracle.com/bpm/bpmobject/" xmlns:jaxb="http://java.sun.com/xml/ns/jaxb" xmlns:ns1="http://assessor.lacounty.gov/amp/data/ao/LogWorkFlowDetails/v1.0" xmlns:inp1="http://assessor.lacounty.gov/amp/type/common/RequestHeader/v1.0" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:tns="http://xmlns.oracle.com/bpel/workflow/task" xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:ns0="http://xmlns.oracle.com/bpm/bpmobject/Data/InitiatorInfoBO" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl ns2 inp2 evidence bpmo jaxb ns1 inp1 xsd tns ns0 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas">
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="contains($LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:processStatus,&quot;Submitted&quot;)">
        <ns1:logWorkFlowDetailsRequest>
          ...
          <ns1:initiatedBy>
            <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:initiatedBy"/>
          </ns1:initiatedBy>
          <ns1:initiatedDate>
            <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:initiatedDate"/>
          </ns1:initiatedDate>
          <ns1:claimedBy>
          ...
          <ns1:owner>
            <xsl:value-of select="$execDataWFLogDO/tns:task/tns:ownerGroup"/>
          </ns1:owner>
          <ns1:notes>
            <xsl:for-each select="$execDataWFLogDO/tns:task/tns:userComment">
              <ns1:notes>
                <ns1:subject>
                  <xsl:value-of select="concat(concat(concat(tns:taskId,&quot;'s &quot;),&quot;comment is &quot;),tns:operation)"/>
                </ns1:subject>
                <ns1:description>
          ...
          <ns1:category>
            <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:category"/>
          </ns1:category>
        </ns1:logWorkFlowDetailsRequest>
      </xsl:when>
      <xsl:when test="contains($LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:processStatus,&quot;Cancelled&quot;) or contains($LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:processStatus,&quot;Errored&quot;)">
        <ns1:logWorkFlowDetailsRequest>
          <ns1:header>
            <inp1:applicationId>
              <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:header/inp1:applicationId"/>
          ...
          <ns1:outcome>
            <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:outcome"/>
          </ns1:outcome>
          <ns1:category>
            <xsl:value-of select="$LogWorkflowDetailsPDO/ns1:logWorkFlowDetailsRequest/ns1:category"/>
          </ns1:category>
